...
public class Alarm_Clock extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setTime.setOnClickListener((v) -> {
            ...
            timePickerDialog = new TimePickerDialog(Alarm_Clock.this, new TimePickerDialog.OnTimeSetListener() {
                @Override
...
//--------------------------End----------------------------------------------
                    ...
                    if(intent.resolveActivity(getPackageManager()) != null) {
                        ...
                        Toast.makeText(Alarm_Clock.this, "There is no app that support this action", Toast.LENGTH_SHORT).show();
                    }
                }else{
                    Toast.makeText(Alarm_Clock.this,"Please choose a time", Toast.LENGTH_SHORT).show();
                }
            }
        });
